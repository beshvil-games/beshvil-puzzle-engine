(() => {
  ...
  const STORAGE_KEY = "beshvilGameAdminV4";
  const PREVIOUS_KEYS = ["beshvilGameAdminV3", "beshvilGameAdminV2", "beshvilGameAdminV1"];
  ...
  const e = {
    ...
    printBranding: document.querySelector("#printBranding"),
  ...
  function loadState() {
    ...
    return {
      ...
      printBranding: saved.printBranding || saved.gameName || "50 לרונית",
  ...
  function sync() {
    ...
    state.printBranding = e.printBranding.value.trim();
  ...
  function render() {
    ...
    e.printBranding.value = state.printBranding;
  ...
  function qrCard(titleText, url, detailsData) {
    ...
    brandWrap.className = "qr-brand-wrap";

    const brandLogo = document.createElement("img");
    brandLogo.className = "qr-brand-logo";
    brandLogo.src = "../assets/logo.png";
    brandLogo.alt = "בשביל החוויה";

    const brandText = document.createElement("div");
    brandText.className = "qr-brand-text";
    brandText.textContent = state.printBranding || state.gameName || "";

    brandWrap.append(brandLogo, brandText);
    ...
    card.append(brandWrap, title, box, details, actions);
